...
public class BoletaVentaPizza extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BoletaVentaPizza frame = new BoletaVentaPizza();
	...
	private void desing() {
		...
		lblPizza.setFont(new Font("Arial", Font.PLAIN, 18));
		lblPizza.setBounds(255, 304, 269, 29);
		...
		lblNewLabel_3_2_2.setBounds(0, 361, 251, 29);
	...
	public void getData(Pizza pizza) {
		lblPizza.setText(pizza.getType());
		lblSize.setText(pizza.getSize());
		lblPrice.setText("S/"+pizza.getPrice());
	}
	
	/**
	 * Create the frame.
	 */
	public BoletaVentaPizza() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(BoletaVentaPizza.class.getResource("/images/logo de la empresa.jpg")));
		desing();

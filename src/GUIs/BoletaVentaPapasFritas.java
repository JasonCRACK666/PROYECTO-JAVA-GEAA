...
public class BoletaVentaPapasFritas extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BoletaVentaPapasFritas frame = new BoletaVentaPapasFritas();
	...
	private void desing() {
		...
		JLabel lblNewLabel_3_1 = new JLabel("Papas fritas");
		...
		lblSize.setBounds(255, 304, 269, 29);
		...
		lblNewLabel_3_2_2.setBounds(0, 333, 251, 29);
		...
		lblPrice.setBounds(255, 333, 269, 29);
	...
	public void getData(PapasFritas papasFritas) {
		lblPrice.setText("S/"+papasFritas.getPrice());
		lblSize.setText(papasFritas.getSize());
	}
	
	/**
	 * Create the frame.
	 */
	public BoletaVentaPapasFritas() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(BoletaVentaPapasFritas.class.getResource("/images/logo de la empresa.jpg")));
		desing();
